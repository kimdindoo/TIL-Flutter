...
OrderProductMdoel _$OrderProductMdoelFromJson(Map<String, dynamic> json) =>
    OrderProductMdoel(
...
Map<String, dynamic> _$OrderProductMdoelToJson(OrderProductMdoel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
OrderProductAndCountModel _$OrderProductAndCountModelFromJson(
    ...
    OrderProductAndCountModel(
      product:
          OrderProductMdoel.fromJson(json['product'] as Map<String, dynamic>),
