...
Uuid _UART_UUID = Uuid.parse("00001F00-8835-40B6-8651-5691F8630806");
Uuid _UART_RX = Uuid.parse("00001F11-8835-40B6-8651-5691F8630806");
Uuid _UART_TX = Uuid.parse("00001F10-8835-40B6-8651-5691F8630806");
                      ...
                      itemBuilder: (context, index) => Card(
                            ...
                            trailing: GestureDetector(
                              ...
                              onTap: () {
                                ...
                                print('connect : $_connected, scan : $_scanning');
                              },
                              child: Container(
                                width: 48,
                                height: 48,
              ...
              Container(
                  ...
                  child: Row(children: <Widget>[
                    ...
                    ElevatedButton(
                        child: Icon(
                          Icons.send,
                          color: _connected ? Colors.orangeAccent : Colors.grey,
                        ),
        ...
        persistentFooterButtons: [
          ...
          ElevatedButton(
            ...
            child: Icon(
              Icons.play_arrow,
              color:
                  !_scanning && !_connected ? Colors.orangeAccent : Colors.grey,
            ),
          ),
          ElevatedButton(
              ...
              child: Icon(
                Icons.stop,
                color: _scanning ? Colors.orangeAccent : Colors.grey,
              )),
          ElevatedButton(
